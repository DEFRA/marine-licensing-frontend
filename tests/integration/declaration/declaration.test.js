...
// describe(`POST ${routes.DECLARATION} - marine licence submission`, () => {
//   beforeEach(() => {
...
//       payload: {
//         message: 'success',
//         value: { applicationReference: 'ML-789' }
//       }
//     })
//   })

//   test('should submit marine licence and redirect to confirmation page', async () => {
...
//       '/marine-licence/confirmation?applicationReference=ML-789'
//     )
...
//   test('should return 400 when marine licence API returns error', async () => {
//     mockMarineLicence(mockMarineLicenceApplication)
//     vi.mocked(authRequests.authenticatedPostRequest).mockResolvedValue({
