...
export const testScenarios = [
  ...
  {
    name: 'WGS84 polygon coordinates - extended with additional points',
    marineLicence: {
      ...baseMlPolygonMarineLicence,
      siteDetails: [
        {
      ...
      siteDetails: [
        {
          ...
          polygonCoordinates: [
            ...
            { label: 'Point 2', value: '33.987654, 33.987654' },
            { label: 'Point 3', value: '78.123456, 78.123456' },
            { label: 'Point 4', value: '45.678901, 45.678901' },
            { label: 'Point 5', value: '56.789012, 56.789012' }
          ]
        }
      ]
    }
  ...
  {
    name: 'OSGB36 polygon coordinates - extended with additional points',
    marineLicence: {
      ...baseMlPolygonMarineLicence,
      siteDetails: [
        {
      ...
      siteDetails: [
        {
          ...
          polygonCoordinates: [
            ...
            { label: 'Point 2', value: '426000, 565000' },
            { label: 'Point 3', value: '427000, 566000' },
            { label: 'Point 4', value: '428000, 567000' },
            { label: 'Point 5', value: '429000, 568000' },
            { label: 'Point 6', value: '430000, 569000' }
          ]
        }
      ]
    }
