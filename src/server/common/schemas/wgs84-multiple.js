import joi from 'joi'
import { createLatitudeSchema, createLongitudeSchema } from './wgs84.js'
 ...
 */
export const createWgs84MultipleCoordinatesSchema = (payload) => {
  const minPoints = 3
  ...
  for (let i = 0; i < pointCount; i++) {
    ...
    schemaFields[`coordinates[${i}][latitude]`] =
      createLatitudeSchema(pointName)
    schemaFields[`coordinates[${i}][longitude]`] =
      createLongitudeSchema(pointName)
  }
