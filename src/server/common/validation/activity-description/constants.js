export const activityDescriptionSettings = {
...
export const activityDescriptionErrorMessages = {
  ...
  ACTIVITY_DESCRIPTION_MAX_LENGTH: `Activity description must be ${ACTIVITY_DESCRIPTION_MAX_LENGTH} characters or less`
}
