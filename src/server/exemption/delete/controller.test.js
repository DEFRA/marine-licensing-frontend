...
describe('#delete', () => {
  ...
  describe('deleteExemptionController', () => {
    describe('handler', () => {
      it('should render the delete confirmation page with project details', async () => {
        ...
        const result = await deleteExemptionController.handler(
          mockRequest,
          mockH
        )
      ...
      it('should redirect to dashboard and log error if API call fails', async () => {
        const mockExemption = { id: 'test-project-id' }
  ...
  describe('deleteExemptionSelectController', () => {
    describe('handler', () => {
      it('should clear cache, set exemption ID in cache, and redirect to delete page', () => {
        ...
        const result = deleteExemptionSelectController.handler(
          mockRequest,
          mockH
        )
  ...
  describe('deleteExemptionSubmitController', () => {
    describe('handler', () => {
      it('should delete exemption and redirect to dashboard when IDs match', () => {
        mockRequest.payload = { exemptionId: 'test-project-id' }
        const mockExemption = { id: 'test-project-id' }
        mockedGetExemptionCache.mockReturnValue(mockExemption)

        const result = deleteExemptionSubmitController.handler(
          mockRequest,
          mockH
        )
      ...
      it('should redirect to dashboard and log error when exemption ID is missing', () => {
        mockRequest.payload = {}
        const mockExemption = { id: 'test-project-id' }
        mockedGetExemptionCache.mockReturnValue(mockExemption)
      ...
      it('should redirect to dashboard and log error when exemption IDs do not match', () => {
      ...
      it('should redirect to dashboard and log error when exception occurs', () => {
        mockRequest.payload = { exemptionId: 'test-project-id' }
        const mockError = new Error('Test error')
        mockedGetExemptionCache.mockImplementation(() => {
          throw mockError
        })
